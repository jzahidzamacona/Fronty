...
export default function NuevoEmpleadoPage() {
  ...
  // ⚠️ Bloqueo por rol (además del Protected de login que ya tienes).
  useEffect(() => {
    if (!isAdmin()) {
      router.replace("/empleados")   // o "/" si prefieres
    }
  }, [router])
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="fechaContratacion" name="fechaContratacion" type="date" value={formData.fechaContratacion} onChange={handleChange} />
              </div>
          ...
          <CardFooter className="flex justify-between">
            <Button variant="outline" type="button" onClick={() => router.push("/empleados")} disabled={loading}>
              Cancelar
            </Button>
